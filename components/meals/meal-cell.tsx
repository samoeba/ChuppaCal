    ...
    >
      {meal ? (
        <>
          ...
          <span className="text-[10px] font-medium text-cc-ink leading-tight line-clamp-2 text-center px-0.5">
            {meal.name}
          </span>
        </>
      ) : (
        <span className="text-cc-ink/20 text-xl font-light leading-none">+</span>
      )}
    </button>
  );
}
